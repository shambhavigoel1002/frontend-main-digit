                    ...
                    {/* configs?.sections?.searchResult?.show &&  
                        <div style={data?.[configs?.sections?.searchResult?.uiConfig?.resultsJsonPath]?.length > 0 ? (!(isLoading || isFetching) ?{ overflowX: "scroll", borderRadius : "4px" }: {}) : {  }} > */}
                            ...
                            <ResultsTable 
                                ...
                                data={data || {items:[
                                    { id: 0, babyFirstName: "Geeta", babyLastName: "Agarwal", hospitalName: "Yashodha Speciality Hospital", placeOfBirth: "Hyderabad" },
                                        { id: 1, babyFirstName: "Rivaan", babyLastName: "Malhotra", hospitalName: "Sharada Speciality Hospital", placeOfBirth: "Pune" },
                                        { id: 2, babyFirstName: "Alice", babyLastName: "Reddy", hospitalName: "Government Speciality Hospital", placeOfBirth: "Jamnagar" },
                                  ]}} 
                                isLoading={isLoading} 
